...
Lo que sí cambia durante la partida son los nombres. Un nombre es una etiqueta: se
corrige porque estaba mal escrito, no toca ningún reloj y no altera nada de lo
pactado.
...
Los nombres se cambian en cualquier momento, también con el partido empezado
(ADR-0003).
