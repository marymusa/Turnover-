...
| `03-aviso-previo.png` | Quedan ocho segundos de turno | Una bocina avisa antes de que se agote |
| `04-tiempo-extra-consumiendose.png` | Turno a cero, el tiempo extra pasa a ser el número grande | Agotado el turno entra el tiempo extra |
| `05-overtime.png` | Tiempo extra agotado, contando en negativo | El reloj deja constancia de lo que se pasa cada uno |
| `06-pausado.png` | El velo de pausa, con los relojes legibles por debajo | Pausar deja leer el tiempo mientras se habla |
| `07-nombres.png` | Luke y Nuffle en sus mitades | Cada jugador se pone su nombre |
